...
<div class="panel">
    ...
    <ul class="mt-7 flex items-center justify-center gap-2">
        <li>
            <a class="btn btn-info flex h-10 w-10 items-center justify-center rounded-full p-0" href="https://github.com/lycuyt/IOT--application">
                <!-- SVG Icon -->
        ...
        <li>
            <a class="btn btn-danger flex h-10 w-10 items-center justify-center rounded-full p-0" href="https://github.com/lycuyt/IOT--application">
                <!-- SVG Icon -->
                <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
        ...
        <li>
            <a class="btn btn-dark flex h-10 w-10 items-center justify-center rounded-full p-0" href="https://github.com/lycuyt/IOT--application">
                <!-- SVG Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5">
